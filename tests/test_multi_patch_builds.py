...
class TestMultiEvergreen(TestRequestsParent):
    ...
    def test_parse_options(self):
        ...
        args = [
            '--description', 'PERF-814 Unit test, please ignore', '-n', '2', '--variants',
            'linux-standalone', '--variants', 'linux-1-node-replSet', '--tasks',
    ...
    def test_evergreen_patch_compile_cmd(self):
        ...
        expected1 = [
            'evergreen', 'patch', '--description', 'PERF-814 Unit test, please ignore #2', '--yes',
            '--project', 'sys-perf', '--variants', 'linux-standalone', '--variants',
            'linux-1-node-replSet', '--tasks', 'core_workloads_WT', '--tasks',
            'core_workloads_MMAPv1'
        ]
        expected2 = [
            'evergreen', 'patch', '--description', 'PERF-814 Unit test, please ignore #3', '--yes',
            '--project', 'sys-perf', '--variants', 'linux-standalone', '--variants',
            'linux-1-node-replSet', '--tasks', 'core_workloads_WT', '--tasks',
            'core_workloads_MMAPv1'
        ]
    ...
    def test_result_urls(self):
        ...
        expected = [{
            'task_ids': [
                u'sys_perf_linux_1_node_replSet_core_workloads_WT_651bc712c372e619513f1cc9564a38bf5b665237_16_12_29_21_39_27',
            ...
            'build_variant_ids': [
                u'sys_perf_linux_1_node_replSet_651bc712c372e619513f1cc9564a38bf5b665237_16_12_29_21_39_27',
            ...
            'build_variant_ids': [
                u'sys_perf_linux_standalone_651bc712c372e619513f1cc9564a38bf5b665237_16_12_29_21_39_24',
