...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_mongodb_auth_settings_disabled(self):
        config = {
            'mongodb_setup': {
                'authentication': {
                    'enabled': False,
    ...
    def test_mongodb_auth_configured_no_password(self):
        config = {
            'mongodb_setup': {
                'authentication': {
                    'enabled': False
        ...
        self.assertEqual(common.mongodb_setup_helpers.mongodb_auth_configured(config), False)
