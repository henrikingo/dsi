...
QHatValues = collections.namedtuple('QHatValues',
                                    ['values', 'average_value', 'average_diff', 'length'])
"""
...
EDivisiveChangePoint = collections.namedtuple('EDivisiveChangePoint', [
    'index', 'value', 'value_to_avg', 'value_to_avg_diff', 'average', 'average_diff', 'window_size',
    'probability'
])
"""
...
if not DSI_DISABLE_NATIVE_E_DIVISIVE and signal_processing.native.e_divisive.LOADED:
    ...
    class EDivisiveNativeImp(EDivisiveNumpyImp):  # pylint: disable=too-many-instance-attributes
        ...
        def _calculate_qhat_values(self, series, diffs, qhat_values):  # pylint: disable=too-many-locals,too-many-branches
            # used as the window size in extract_q
