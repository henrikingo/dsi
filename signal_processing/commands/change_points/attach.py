...
def get_field_value(build_failure, field_name):
    ...
    :param jira.JIRA build_failure: The jira issue.
...
def get_issue_state(build_failure):
    ...
    :param jira.JIRA build_failure: A reference to the remote build failure.
...
def attach(build_failure, test_identifiers, fix, command_config):
    ...
    :param str build_failure: The Build Failure id.
    :param dict test_identifiers: The change point meta data.
